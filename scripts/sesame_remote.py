...
def main():
    ...
    with term.cbreak(), term.hidden_cursor():
        ...
        while True:
            ...
            elif char == '1': STATE["status"]="ACTIVE"; STATE["last_cmd"]="STAND"; [set_angle(ch, val) for ch, val in HOME.items()]; HISTORY.append("Stand")
            elif char == '2': STATE["status"]="ACTIVE"; STATE["last_cmd"]="REST"; [set_angle(i, 90) for i in range(8)]; HISTORY.append("Resting")
            elif char == '3': STATE["status"]="ACTIVE"; STATE["last_cmd"]="BOW"; run_mvmt("bow"); HISTORY.append("Bowing")
            elif char == '4': STATE["status"]="ACTIVE"; STATE["last_cmd"]="WAVE"; run_mvmt("wave"); HISTORY.append("Waving")
