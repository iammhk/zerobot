...
def main():
    ...
    with term.cbreak(), term.hidden_cursor():
        ...
        while True:
            ...
            elif char == '3': STATE["status"]="ACTIVE"; STATE["last_cmd"]="BOW"; run_mvmt("bow"); HISTORY.append("Bowing"); expr.happy(looking="down")
            elif char == '4': STATE["status"]="ACTIVE"; STATE["last_cmd"]="WAVE"; run_mvmt("wave"); HISTORY.append("Waving"); expr.wink()
            elif char == '5': STATE["status"]="ACTIVE"; STATE["last_cmd"]="BOUNCE"; run_mvmt("bounce"); HISTORY.append("Bouncing")
            ...
            elif char == '9': STATE["status"]="ACTIVE"; STATE["last_cmd"]="CUTE"; run_mvmt("cute"); HISTORY.append("Cute Mode"); expr.love()
            elif char == '0': STATE["status"]="ACTIVE"; STATE["last_cmd"]="SHRUG"; run_mvmt("shrug"); HISTORY.append("Shrugging"); expr.pondering()
