...
from zerobot.agent.autocompact import AutoCompact
...
from zerobot.agent.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
...
from zerobot.command import CommandContext, CommandRouter, register_builtin_commands
...
from zerobot.utils.helpers import image_placeholder_text
from zerobot.utils.helpers import truncate_text as truncate_text_fn
from zerobot.utils.progress_events import (
...
if TYPE_CHECKING:
    from zerobot.config.schema import ChannelsConfig, ExecToolConfig, ToolsConfig, WebToolsConfig
...
class AgentLoop:
    ...
    def __init__(
        ...
        # Zerobot_MAX_CONCURRENT_REQUESTS: <=0 means unlimited; default 3.
        _max = int(os.environ.get("Zerobot_MAX_CONCURRENT_REQUESTS", "3"))
