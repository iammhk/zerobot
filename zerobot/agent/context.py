...
from zerobot.utils.helpers import build_assistant_message, current_time_str, detect_image_mime
...
class ContextBuilder:
    ...
    BOOTSTRAP_FILES = ["BODY.md", "AGENTS.md", "SOUL.md", "USER.md", "TOOLS.md"]
