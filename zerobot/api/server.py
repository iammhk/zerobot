"""OpenAI-compatible HTTP API server for a fixed Zerobot session.
...
async def handle_chat_completions(request: web.Request) -> web.Response:
    ...
    model_name: str = request.app.get("model_name", "Zerobot")
...
async def handle_models(request: web.Request) -> web.Response:
    """GET /v1/models"""
    model_name = request.app.get("model_name", "Zerobot")
    return web.json_response(
        {
            "object": "list",
            "data": [
...
def create_app(
    agent_loop, model_name: str = "Zerobot", request_timeout: float = 120.0
) -> web.Application:
