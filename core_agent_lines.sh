...
echo "zerobot line count"
echo "=================="
echo ""

echo "Core runtime"
echo "------------"
core_agent=$(count_top_level_py_lines "zerobot/agent")
core_bus=$(count_top_level_py_lines "zerobot/bus")
core_config=$(count_top_level_py_lines "zerobot/config")
core_cron=$(count_top_level_py_lines "zerobot/cron")
core_heartbeat=$(count_top_level_py_lines "zerobot/heartbeat")
core_session=$(count_top_level_py_lines "zerobot/session")
...
echo "----------------"
extra_tools=$(count_recursive_py_lines "zerobot/agent/tools")
extra_skills=$(count_skill_lines "zerobot/skills")
extra_api=$(count_recursive_py_lines "zerobot/api")
extra_cli=$(count_recursive_py_lines "zerobot/cli")
extra_channels=$(count_recursive_py_lines "zerobot/channels")
extra_utils=$(count_recursive_py_lines "zerobot/utils")
...
echo "Notes"
echo "-----"
echo "  - agent/ only counts top-level Python files under zerobot/agent"
echo "  - tools/ is counted separately from zerobot/agent/tools"
echo "  - skills/ counts .md, .py, and .sh files"
echo "  - not included here: command/, providers/, security/, templates/, zerobot.py, root files"
